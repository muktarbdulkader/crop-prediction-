...
import type { PredictionParams, PredictionResult, Language, LeafAnalysisResult } from '../types';
...
export const analyzeSoil = async (ai: GoogleGenAI, imageBase64: string, mimeType: string, prompt: string, language: Language): Promise<string> => {
    const imagePart = {
        inlineData: {
            data: imageBase64,
            mimeType,
