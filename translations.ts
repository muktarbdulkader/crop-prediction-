export const translations = {
  en: {
    ...
    footer:
      "AI-powered crop prediction system helping farmers and students estimate yields, improve decisions, reduce risks, and support smarter, sustainable agriculture.",
    language: "Language",
    ...
    askBotPrompts: {
      ...
      product:
        "Tell me more about the safe handling and potential environmental impact of this product.",
    },
    ...
    customPromptPlaceholder:
      "e.g., 'Prefer a drought-resistant crop', 'Needs to be harvestable within 90 days', etc.",
    history: {
    ...
    productAnalysisPrompt:
      'e.g., "What is this for?", "What is the expiry date?", "How do I use this safely?"',
    productScannerDefaultPrompt:
      "Identify this agricultural product and provide details on its usage, active ingredients, manufacturing/expiry dates, and safety precautions.",
    ...
    proFeatures: {
      ...
      agriBotMic:
        "Voice input is a Pro feature. Upgrade to ask questions hands-free!",
      cropGuide:
        "Generating a comprehensive farming guide is a Pro feature. Upgrade for detailed instructions.",
      treatmentPlan:
        "Get specific treatment recommendations by upgrading to Agri-AI Pro.",
      soilAmendments:
        "Unlock detailed, cost-effective soil amendment advice by upgrading to Pro.",
      productSafety:
        "Unlock critical safety precautions and first-aid information by upgrading to Pro.",
    },
    ...
    errors: {
      ...
      PRODUCT_ANALYSIS_FAILED:
        "Failed to analyze the product image. Please try again with a clearer image.",
  ...
  am: {
    ...
    askBotPrompts: {
      ...
      product:
        "ስለዚህ ምርት ደህንነቱ የተጠበቀ አያያዝ እና ሊያስከትል ስለሚችለው የአካባቢ ተጽእኖ የበለጠ ንገረኝ።",
    },
    ...
    customPromptPlaceholder:
      "ለምሳሌ፣ 'ድርቅን የሚቋቋም ሰብል እፈልጋለሁ'፣ 'በ90 ቀናት ውስጥ መሰብሰብ አለበት'፣ ወዘተ።",
    history: {
      title: "የትንበያ ታሪክ",
      show: "ታሪክን ተመልከት",
      hide: "ታሪክን ደብቅ",
    ...
    productAnalysisPrompt:
      'ለምሳሌ፣ "ይህ ለምንድን ነው?", "የሚያበቃበት ቀን ስንት ነው?", "እንዴት በደህና መጠቀም እችላለሁ?"',
    productScannerDefaultPrompt:
      "ይህንን የግብርና ምርት ይለዩ እና ስለ አጠቃቀሙ፣ ስለ ንቁ ንጥረ ነገሮች፣ ስለ ማምረቻ/የሚያበቃበት ቀን እና ስለ ደህንነት ጥንቃቄዎች ዝርዝር መረጃ ይስጡ።",
    ...
    errors: {
      ...
      PRODUCT_ANALYSIS_FAILED:
        "የምርቱን ምስል መተንተን አልተቻለም። እባክዎ ግልጽ በሆነ ምስል እንደገና ይሞክሩ።",
  ...
  om: {
    ...
    footer:
      "Sirni AI kun midhaan tilmaama, balaa hir’isa, murtee qonnaa fooyyessa, hojii qonnaan bultoota fi barattootaaf gargaaruu danda’a.",
    language: "Afaan",
    ...
    askBotPrompts: {
      ...
      product:
        "Waa'ee qabiyyee fi dhiibbaa naannoo oomisha kanaa bal'inaan natti himi.",
    },
    ...
    awaitingPredictionDesc:
      "fakenya  keessan galchaatii bu'aa argachuuf \"Oomisha Ol'aanaa Tilmaami\" glachi.",
    ...
    customPromptPlaceholder:
      "fkn, 'Oomisha honge dandamatuun filadha', 'Guyyaa 90 keessatti sassaabamuu qaba', kkf.",
    history: {
    ...
    visualReferenceProTooltip:
      "yemmu kafalte : Mirkaneessa mul'ataa gaarii argachuuf suuraa dhugaa fakkaatu kan rakkoo adda baafame uuma.",
    ...
    productAnalysisPrompt:
      'fkn, "Kun maalfa\'aaf oola?", "Guyyaan itti darbu yoomi?", "Akkamittin nageenyaan fayyadama?"',
    productScannerDefaultPrompt:
      "Oomisha qonnaa kana adda baasiitii waa'ee fayyadama isaa, qabiyyee isaa, guyyaa oomishaa/itti darbuu, fi ofeeggannoo nageenyaa ilaalchisee odeeffannoo kenni.",
    ...
    proFeatures: {
      ...
      agriBotMic:
        "Galtee sagalee amala Pro ti. Gaaffiiwwan harka malee gaafachuuf guddisi!",
      cropGuide:
        "Qajeelfama qonnaa bal'aa uumuun amala Pro ti. Qajeelfama gadi fageenya qabuuf guddisi.",
      treatmentPlan:
        "Gara Agri-AI Pro tti guddisuun gorsa yaalaa addaa argadhu.",
      soilAmendments:
        "Gorsa fooyya'iinsa biyyee gadi fageenya qabuufi gatii madaalawaa argachuuf gara Pro tti guddisi.",
      productSafety:
        "Ofeeggannoo nageenyaa barbaachisaa fi odeeffannoo gargaarsa duraa argachuuf gara Pro tti guddisi.",
    },
    ...
    errors: {
      ...
      PRODUCT_ANALYSIS_FAILED:
        "Suuraa oomishaa xiinxaluun hin danda'amne. Maaloo suuraa ifa ta'een irra deebi'ii yaali.",
      TREATMENT_PLAN_FAILED:
      ...
      GROWTH_STAGE_FAILED:
        "Qajeelfama sadarkaa guddina biqiltuu uumuun hin danda'amne.",
      DISEASE_EXTRACTION_FAILED:
      ...
      speechPermissionDenied:
        "Hayyamni maaykiroofoonii eeyyamamuu dide. Amala kana fayyadamuun qindaa'ina biraawzarii kee keessatti banaa godhi.",
